"""
Пакет содержит тексты inline кнопок на двух языках (где это требуется), а также callback inline кнопок.
Каждая двуязычная переменная - словарь с ключами Ru и En соответственно
"""
